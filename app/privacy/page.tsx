      ...
      sections: [
        {
          ...
          content:
            'Your account is protected by encryption and secure authentication methods. We recommend using a strong, unique password.',
          icon: Lock,
        },
        {
        ...
        },
        {
          ...
          content:
            'We conduct regular security audits and vulnerability assessments to ensure your data remains secure.',
          icon: CheckCircle,
        },
        {
          title: 'Incident Response',
          content:
            'In the unlikely event of a security incident, we have procedures in place to respond quickly and notify affected users.',
          icon: AlertTriangle,
        },
      ],
    },
      ...
      sections: [
        {
          ...
          content:
            'We only collect data that is necessary to provide our services. This includes profile information, booking history, and usage analytics.',
          icon: Info,
        },
        {
          title: 'Your Rights',
        ...
        },
        {
          ...
          content:
            'We may use trusted third-party services for analytics and payments. These partners are bound by strict data protection agreements.',
          icon: Shield,
        },
      ],
    },
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-blue-800 mb-4">
                If you have any questions about our privacy practices or need to update your
