...
export async function GET(req: NextRequest) {
  try {
    ...
    const platformCounts: Record<string, number> = { android: 0, iphone: 0, ipad: 0, desktop: 0, other: 0 }
    const browserCounts: Record<string, number> = { chrome: 0, safari: 0, edge: 0, firefox: 0, other: 0 }
    ...
    return Response.json({ from, to, platform: platformCounts, browser: browserCounts }, { headers: corsHeaders(req) })
  } catch (e: any) {
