  ...
  const faqs: FAQ[] = [
    {
      ...
      answer:
        'You can book a service by browsing our categories, selecting a service, and clicking "Book via WhatsApp". You\'ll be redirected to WhatsApp to complete your booking with our team.',
      category: 'booking',
    },
    {
      id: '2',
      ...
      answer:
        'We accept various payment methods including UPI, credit/debit cards, net banking, and cash payments. Payment terms are discussed during the booking process.',
      category: 'payment',
    },
    {
      id: '3',
      ...
      answer:
        'You can cancel or reschedule your booking by contacting the service provider directly via WhatsApp or calling our support team. Cancellation policies may vary by service.',
      category: 'booking',
    },
    {
      id: '4',
      ...
      answer:
        'Yes, all our service providers go through a verification process including background checks, skill assessments, and customer reviews to ensure quality service.',
      category: 'safety',
    },
    {
      id: '5',
      ...
      answer:
        "If you're not satisfied with the service, please contact our support team within 24 hours. We'll work with you and the provider to resolve the issue or provide a refund if applicable.",
      category: 'support',
    },
    {
      id: '6',
      ...
      answer:
        "To become a service provider, you can apply through our partner registration process. We'll review your application, verify your credentials, and onboard you to our platform.",
      category: 'provider',
    },
  ];
  ...
  const contactMethods = [
    ...
    },
    {
      ...
      onClick: () => {
        ...
        if (!supportPhone) {
          console.warn('Support phone not configured');
          return;
        }
      ...
      <div className="pt-4 pb-20 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          {contactMethods.map((method, index) => (
            ...
            >
              <div
                className={`w-12 h-12 ${method.color} rounded-xl flex items-center justify-center text-white mb-3`}
              >
        ...
        <div className="bg-gradient-to-r from-blue-50 to-green-50 border border-blue-200 rounded-2xl p-6 text-center">
          ...
          <button
            onClick={() => {
              const message =
                "Hi! I need help with Taliyo Marketplace services. I couldn't find the answer to my question in the FAQ.";
