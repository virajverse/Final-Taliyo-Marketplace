...
export default function Header({ cartCount = 0 }: HeaderProps) {
  ...
  return (
    <div
      className="sticky top-0 bg-white dark:bg-gray-950 shadow-sm z-40 border-b border-gray-200 dark:border-gray-800"
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="flex-1 min-w-0 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900 dark:text-gray-100 placeholder:text-gray-400 placeholder:dark:text-gray-500"
            />
          </div>
